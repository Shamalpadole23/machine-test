      ...
      editFormVisibility===false?(
        <form className='form-group custom-form' onSubmit={handleSubmit}>
          ...
          <div className='input-and-btn'>
              <input type="text" className='form-control' placeholder='Add your todo-items' required
        ...
        <form className='form-group custom-form' onSubmit={editSubmit}>
          ...
          <div className='input-and-btn'>
              <input type="text" className='form-control' placeholder='Update your todo-items' required
